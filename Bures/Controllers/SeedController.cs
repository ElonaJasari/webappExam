...
using Bures.Data;
using Bures.Models;
using Bures.StoryContent.Act1;
using Bures.StoryContent.Act2;
using Bures.StoryContent.Act3;
        ...
        private static IEnumerable<dynamic> GetAllScenesInOrder()
        {
            ...
            var sceneProviderTypes = assembly.GetTypes()
                .Where(t => t.Namespace != null && 
                           (t.Namespace.StartsWith("Bures.StoryContent.Act1") ||
                            t.Namespace.StartsWith("Bures.StoryContent.Act2") ||
                            t.Namespace.StartsWith("Bures.StoryContent.Act3")))
